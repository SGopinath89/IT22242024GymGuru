    ...
    <>
      ...
      <div className="mt-5">
        <div className="relative w-700 h-[300px] bg-gray-100 border-2 border-gray-400 mt-3 mb-3 mx-5 flex items-start"> 
          <img src={ex1} alt="Description of the image" width="280" height="300" />
          <div className="flex flex-col justify-start ml-4"> {/* Aligning text after vertical line */}
            <h1 className="font-bold text-3xl ml-100 mt-5  mb-5">Lat pulldown</h1>
            <p className="mr-5">
            The <b>back squat</b> is one of the most effective and widely used exercises for building strength, particularly in the lower body. It primarily targets the quadriceps, hamstrings, glutes, and lower back, making it a comprehensive lower body workout. The exercise involves placing a barbell across the upper back, usually resting on the traps, while standing with feet shoulder-width apart. From this position, the individual lowers their body by bending their knees and hips, essentially sitting back into a squat. The depth of the squat can vary depending on flexibility, mobility, and personal goals, but a common benchmark is to lower the thighs to parallel with the ground. After reaching the desired depth, the person then drives through their heels to return to the standing position.
    ...
    {/*Leg squat*/}
      <div className="mt-5">
        <div className="relative w-700 h-[300px] bg-gray-100 border-2 border-gray-400 mt-3 mb-3 mx-5 flex items-start"> 
          <img src={ex1} alt="Description of the image" width="280" height="300" />
          <div className="flex flex-col justify-start ml-4"> {/* Aligning text after vertical line */}
            <h1 className="font-bold text-3xl ml-100 mt-5  mb-5">Leg squat</h1>
            <p className="mr-5">
            The <b>back squat</b> is one of the most effective and widely used exercises for building strength, particularly in the lower body. It primarily targets the quadriceps, hamstrings, glutes, and lower back, making it a comprehensive lower body workout. The exercise involves placing a barbell across the upper back, usually resting on the traps, while standing with feet shoulder-width apart. From this position, the individual lowers their body by bending their knees and hips, essentially sitting back into a squat. The depth of the squat can vary depending on flexibility, mobility, and personal goals, but a common benchmark is to lower the thighs to parallel with the ground. After reaching the desired depth, the person then drives through their heels to return to the standing position.
      ...
      <div className="mt-5">
        <div className="relative w-700 h-[300px] bg-gray-100 border-2 border-gray-400 mt-3 mb-3 mx-5 flex items-start"> 
          ...
          <div className="flex flex-col justify-start ml-4"> {/* Aligning text after vertical line */}
            <h1 className="font-bold text-3xl ml-100 mt-5  mb-5">Shoulder press</h1>
            <p className="mr-5">
            The <b>back squat</b> is one of the most effective and widely used exercises for building strength, particularly in the lower body. It primarily targets the quadriceps, hamstrings, glutes, and lower back, making it a comprehensive lower body workout. The exercise involves placing a barbell across the upper back, usually resting on the traps, while standing with feet shoulder-width apart. From this position, the individual lowers their body by bending their knees and hips, essentially sitting back into a squat. The depth of the squat can vary depending on flexibility, mobility, and personal goals, but a common benchmark is to lower the thighs to parallel with the ground. After reaching the desired depth, the person then drives through their heels to return to the standing position.
    ...
    {/*Crunchers*/}
      <div className="mt-5">
        <div className="relative w-700 h-[300px] bg-gray-100 border-2 border-gray-400 mt-3 mb-3 mx-5 flex items-start"> 
          <img src={ex1} alt="Description of the image" width="280" height="300" />
          <div className="flex flex-col justify-start ml-4"> {/* Aligning text after vertical line */}
            <h1 className="font-bold text-3xl ml-100 mt-5  mb-5">Crunchers</h1>
            <p className="mr-5">
            The <b>back squat</b> is one of the most effective and widely used exercises for building strength, particularly in the lower body. It primarily targets the quadriceps, hamstrings, glutes, and lower back, making it a comprehensive lower body workout. The exercise involves placing a barbell across the upper back, usually resting on the traps, while standing with feet shoulder-width apart. From this position, the individual lowers their body by bending their knees and hips, essentially sitting back into a squat. The depth of the squat can vary depending on flexibility, mobility, and personal goals, but a common benchmark is to lower the thighs to parallel with the ground. After reaching the desired depth, the person then drives through their heels to return to the standing position.
